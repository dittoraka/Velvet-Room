                        ...
                        <div class="main-left-sidebar no-margin">
                            <div class="user-data full-width">
                                ...
                                <ul class="user-fw-status">
                                    <li>
                                        <h4>Badges</h4>
                                        <span>@if ($achiev == null || ($achiev/5)<1)
                                            {{0}}
                                        @else
                                            {{$achiev/5}}
                                        @endif</span>
                            ...
                            <div class="posts-section">
                                ...
                                <div class="post-bar">
                                        <div class="post_topbar">
                                                <div class="usy-dt" style="margin-bottom:15px">
                                                    @foreach ($user as $key)
                                                ...
                                                <ul class="like-com">
                                                    <li>
                                                            <form action="/postlike">
                                                                ...
                                                                @endforeach
                                                                    @if ($bol)
                                                                        <button type="submit" class="btn btn-primary"> <span style="margin-left:0.5px;margin-right:8px;">{{$item->likes}}</span> <i class="fas fa-thumbs-up"></i> Like</a>
                                                                    @else
                                                                        <button type="submit" class="btn btn-danger"> <span style="margin-left:0.5px;margin-right:8px;background-color:#ec8aa8">{{$item->likes}}</span><i class="fa fa-thumbs-down"></i> Unlike</a>
                                                                    @endif
                                                            </form>
                                            ...
                                            <div>
                                                @foreach ($komen as $ko)
                                                    @if ($ko->id_post == $item->id_post)
                                                        @foreach ($user as $key)
                                                            @if ($ko->nickname == $key->nickname)
                                                                <div style="border:1px solid lightgray;padding:15px;">
                                                                <img src="profil/{{$key->profil_picture}}" style="width:30px;height:30px" alt="">
                                                            @endif
                                                        @endforeach

                                                            <h2 style="font-weight:bold;margin-left:40px">{{$ko->nickname}}</h2>
                                                            <span style="word-wrap:break-word;margin-left:10px">{{$ko->comments}}</span>
